<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="view_cust.aspx.cs" Inherits="ShoesShopSystem.WebForm7" EnableEventValidation="false" %>
    ...
    <div class="col-sm-9">
        ...
        <form id="form1">
            <asp:GridView ID="GridView1" CssClass="table" runat="server" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                ...
                <EmptyDataTemplate>
                    <span style="color: orangered;">No Customer Yet !</span>
                </EmptyDataTemplate>
            </asp:GridView>
