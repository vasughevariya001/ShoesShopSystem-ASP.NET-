<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="view_feedback.aspx.cs" Inherits="ShoesShopSystem.WebForm20" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1">
        <asp:GridView ID="GridView4" CssClass="table" runat="server" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="GridView4_SelectedIndexChanged">
            ...
            <EmptyDataTemplate>
                <span style="color: orangered;">No Feedback Yet !</span>
            </EmptyDataTemplate>
        </asp:GridView>
