<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="staff_dashboard.aspx.cs" Inherits="ShoesShopSystem.WebForm45" %>
    ...
    <div class="col-sm-9">
        <div class="cards">
            <div class="total-user">
                <a href="staff_view_cust.aspx"><span class="glyphicon glyphicon-user icon"></span></a>
            ...
            <div class="total-product">
                <a href="staff_view_product.aspx"><span class="glyphicon glyphicon-stats icon"></span></a>
            ...
            <div class="total-orders">
                <a href="staff_view_order.aspx"><span class="glyphicon glyphicon-list-alt icon"></span></a>
            ...
            <div class="total-feedback">
                <a href="staff_view_feedback.aspx"><span class="glyphicon glyphicon-envelope icon"></span></a>
            ...
            <div class="complete-payment">
                <a href="staff_view_payment.aspx"><span class="glyphicon glyphicon-usd icon"></span></a>
            ...
            <div class="total-staff">
                <a href="#"><span class="glyphicon glyphicon-user icon"></span></a>
