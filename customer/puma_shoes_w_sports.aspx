<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="puma_shoes_w_sports.aspx.cs" Inherits="ShoesShopSystem.WebForm30" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/puma_women's/puma_w_sports_background.jpg" class="img" alt="img">

        <div class="puma-shoes">
            <h1>Puma
                <br>
                <span>Women's - Sports</span></h1>
        </div>
        <div class="text">
            <p>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="puma_shoes_w_sneaker.aspx">Sneakers</a>
                <a href="puma_shoes_w_running.aspx">Running</a>
                <a href="#categories-row-1">Sports</a>
            </div>
        </div>
    </section>
    ...
    <section id="text">
        <div class="info">
            ...
            <button type="submit" class="btn-explore" name=""><a href="#categories-row-2">Explore Sports &nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a></button>
        </div>
    </section> 
    ...
    <section id="contact">
        ...
        <div class="contact-logo reveal">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14876.171737263845!2d72.9018936!3d21.230146!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be0458ad5141465%3A0x9289d379d8ae4d4!2sRise%20On%20Plaza!5e0!3m2!1sen!2sin!4v1694705163711!5m2!1sen!2sin" 
                width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" alt="Map Loading Error">
            </iframe>
        </div>
        ...
        <div class="contact-details reveal">
            ...
            <h2 class="address"><i style="color: #000;" class="glyphicon glyphicon-map-marker"></i>&nbsp;&nbsp;A - 101 , Rise On Plaza , Ground Flore , <br>&nbsp;&nbsp;Sarthana Jakatnaka , Surat-kamrej Highway <br>&nbsp;&nbsp;| Gujarat - 395008.</h2>
        </div>
