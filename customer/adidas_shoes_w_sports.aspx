<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adidas_shoes_w_sports.aspx.cs" Inherits="ShoesShopSystem.WebForm36" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/adidas_women's/adidas_w_sports_background.jpg" class="img" alt="img">
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="#categories-row-2">Sports</a>
            </div>
        </div>
    </section>
