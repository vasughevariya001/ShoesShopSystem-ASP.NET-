<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="ShoesShopSystem.customer.feedback" %>
    ...
    <div class="container-fluid">
        <div class="row content">
            <div class="col-sm-3 sidenav hidden-xs">
                ...
                <%--<h5>Hello,</h5>
                <h3 style="position: relative; color: #fff; left: 38%; top: -15px;"><%= UserName %></h3>--%>
                ...
                <div class="menu">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li><a href="change_pass.aspx"><span class="glyphicon glyphicon-lock"></span>&nbsp; Change Password</a></li>
                        <li class="active"><a href="feedback.aspx"><span class="glyphicon glyphicon-envelope"></span>&nbsp; Feedback</a></li>
                        <hr>
            ...
            <div class="col-sm-9">
                <div class="container">
                    <asp:Repeater ID="CustomerRepeater" OnItemCommand="CustomerRepeater_ItemCommand">
                        <ItemTemplate>
                            <form id="updateProfileForm" runat="server">
                                ...
                                <div class="inputbox">
                                    <asp:TextBox ID="email" runat="server" TextMode="Email" CssClass="form-control" required="required"></asp:TextBox>
                                    <span>Email id</span>
                                    <i></i>
                                </div>
                                <br>
                                ...
                                <div class="inputbox">
                                    <asp:TextBox ID="message" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                    <span>Your Message</span>
                                    <i></i>
                                </div>

                                <div class="buttons">
                                    <asp:Button ID="submit" runat="server" OnClick="Submit_Click" Text="Send Feedback" CommandName="SubmitFeedback" CssClass="btn" />
                                </div>
                            </form>
                        </ItemTemplate>
                    </asp:Repeater>
