<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="uspolo_shoes_m_loafers.aspx.cs" Inherits="ShoesShopSystem.WebForm24" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/uspolo_men's/uspolo_loafer_background.jpg" class="img">

        <div class="puma-shoes">
            <h1>U.S. Polo
                <br>
                <span>Men's - Loafers</span></h1>
        </div>
        <div class="text">
            <p>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="uspolo_shoes_m_sneaker.aspx">Sneakers</a>
                <a href="#categories-row-1">Loafers</a>
            </div>
        </div>
    </section>
    ...
    <section id="text">
        <div class="info">
            <h1>oldest sports in U.S</h1>
            <h2>Play Together uspa</h2>
            <button type="submit" class="btn-explore" name=""><a href="#categories-row-2">Explore Loafers &nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a></button>
        </div>
    </section>
