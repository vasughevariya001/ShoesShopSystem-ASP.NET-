<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="uspolo_shoes_m_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm23" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/uspolo_men's/uspolo_sneaker_background.jpg" class="img">
        ...
        <div class="text">
            <p>
                Stylish in looks, let your shoes do the talking wherever you go. 
                Coordinate your look with a tee, faded denims, and funky 
                wayfarer sunglasses. U.S. POLO ASSN.
            </p>
        </div>
    </section>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="uspolo_shoes_m_loafers.aspx">Loafers</a>
            </div>
        </div>
    </section>
    ...
    <section id="text">
        <div class="info">
            <h1>Legends Forever</h1>
            <h2>Play Together uspa</h2>
