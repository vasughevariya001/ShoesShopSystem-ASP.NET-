<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adidas_shoes_w_running.aspx.cs" Inherits="ShoesShopSystem.WebForm35" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/adidas_women's/adidas_w_running_background.jpg" class="img" alt="img">

        <div class="puma-shoes">
            <h1>Adidas
                <br>
                <span>Women's - Running</span></h1>
        </div>
        <div class="text">
            <p>
    ...
    <section id="text">
        <div class="info">
            <h1>New in Running</h1>
            <h2>Kick it up a notch</h2>
            <button type="submit" class="btn-explore" name=""><a href="#categories-row-2">Explore Running &nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a></button>
        </div>
    </section>
