<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="uspolo_shoes_w_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm31" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/uspolo_women's/uspolo_w_sneaker_background.jpg" class="img" alt="img">
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="uspolo_shoes_w_running.aspx">Running</a>
                <a href="uspolo_shoes_w_sports.aspx">Sports</a>
            </div>
        </div>
    </section>
