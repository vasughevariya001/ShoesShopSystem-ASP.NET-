<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adidas_shoes_m_sports.aspx.cs" Inherits="ShoesShopSystem.WebForm27" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/adidas_men's/adidas_sports_background.jpg" class="img">
    ...
    <section id="text">
        <div class="info">
            ...
            <button type="submit" class="btn-explore" name=""><a href="#categories-row-2">Explore Sports shoes &nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a></button>
        </div>
    </section>
