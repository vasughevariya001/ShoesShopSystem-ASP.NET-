<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="puma_shoes_m_running.aspx.cs" Inherits="ShoesShopSystem.WebForm16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/puma_men's/puma_running_background.jpeg" class="img" alt="Puma Running">
        ...
        <div class="text">
            <p>
                For those looking to take their running to the next level, PUMA running 
                shoes for men are the perfect choice. With a focus on providing unparalleled 
                comfort and support, these shoes will be your feet's perfect companion for every stride.
            </p>
        </div>
    </section>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="#categories-row-2">Running</a>
            ...
            <asp:Repeater ID="ProductRepeater" runat="server">
                <ItemTemplate>
                    <div class="card">
                        ...
                        <h6 class="size">Size :<input type="number" step="1" min="6" max="11" name="size" value="6" size="4" style="padding: 3px;"></h6>
    ...
    <section id="text">
        <div class="info">
            <h1>A classic Decade</h1>
            <h2>help you achieve your fitness goals</h2>
