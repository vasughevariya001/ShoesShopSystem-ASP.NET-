<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="puma_shoes_m_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/puma_men's/puma_sneaker_background.jpg" class="img" alt="img">

        <div class="puma-shoes">
            <h1>Puma
                <br>
                <span>Men's - Sneakers</span></h1>
        </div>
        <div class="text">
            <p>
                Designed with meticulous attention to detail, the PUMA men's sneakers
                 combine fashion-forward aesthetics with advanced athletic technology. 
                 The premium materials used in their construction ensure durability 
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="#categories-row-1">Sneakers</a>
                <a href="puma_shoes_m_running.aspx">Running</a>
                <a href="puma_shoes_m_sports.aspx">Sports</a>
            </div>
        </div>
    </section>
            ...
            <asp:Repeater ID="ProductRepeater" runat="server">
                <ItemTemplate>
                    <div class="card">
                        ...
                        <%--<input type="hidden" name="image" value='<%# Eval("image") %>' />
                        <input type="hidden" name="brand" value='<%# Eval("brand") %>' />
                        <input type="hidden" name="category" value='<%# Eval("category") %>' />
                        <input type="hidden" name="description" value='<%# Eval("description") %>' />
                        <input type="hidden" name="price" value='<%# Eval("nprice") %>' />
                        <input type="hidden" name="o_price" value='<%# Eval("oprice") %>' />
    ...
    <section id="text">
        <div class="info">
            <h1>New in Sneakers</h1>
            <h2>Kick it up a notch</h2>
            <button type="submit" class="btn-explore" name=""><a href="#categories-row-2">Explore Sneakers &nbsp;<span class="glyphicon glyphicon-arrow-right"></span></a></button>
        </div>
    </section>
    ...
    <!------------------------------- Script for produc</ItemTemplate>
            </asp:Repeater>t details (Bootstrap) -------------------------->
    <script>
