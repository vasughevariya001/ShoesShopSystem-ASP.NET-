<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_profile.aspx.cs" Inherits="ShoesShopSystem.customer.update_profile" %>
            ...
            <div class="col-sm-3 sidenav hidden-xs">
                ...
                <div class="menu">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="update_profile.aspx"><span class="glyphicon glyphicon-edit"></span>&nbsp; Update Profile</a></li>
            ...
            <div class="col-sm-9">
                <div class="container">
                    <form id="updateProfileForm" runat="server">
                        ...
                        <div class="inputbox">
                            <asp:TextBox ID="cityTextBox" runat="server" CssClass="form-control" required></asp:TextBox>
                            <span>City</span>
                            <i></i>
                        </div>
