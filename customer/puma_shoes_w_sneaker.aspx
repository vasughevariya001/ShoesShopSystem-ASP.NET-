<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="puma_shoes_w_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm28" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/puma_women's/puma_sneaker_background.jpg" class="img" alt="img">
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="puma_shoes_w_sports.aspx">Sports</a>
            </div>
        </div>
    </section>
