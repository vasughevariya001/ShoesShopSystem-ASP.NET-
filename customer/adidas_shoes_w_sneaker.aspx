<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adidas_shoes_w_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm34" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/adidas_women's/adidas_w_sneaker_background.jpg" class="img" alt="img">

        <div class="puma-shoes">
            <h1>Adidas
                <br>
                <span>Women's - Sneakers</span></h1>
        </div>
        <div class="text">
            <p>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="adidas_shoes_w_sneaker.aspx">Sneakers</a>
                <a href="adidas_shoes_w_running.aspx">Running</a>
                <a href="adidas_shoes_w_sports.aspx">Sports</a>
            </div>
        </div>
    </section>
