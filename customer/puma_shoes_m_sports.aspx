<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="puma_shoes_m_sports.aspx.cs" Inherits="ShoesShopSystem.WebForm15" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/puma_men's/puma_sports_background.jpg" class="img" alt="Puma Running">

        <div class="puma-shoes">
            <h1>Puma
                <br>
                <span>Men's - Sports</span></h1>
        </div>
        <div class="text">
            <p>
                Meet the next generation of motorsport. We’re pushing the boundaries 
                of innovation in sport and fashion with premium collaborations from 
                Scuderia Ferrari, Mercedes-AMG Petronas, Red Bull Racing, BMW Motorsport, 
                and Porsche Design.
            </p>
        </div>
    </section>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="puma_shoes_m_sneaker.aspx">Sneakers</a>
    ...
    <section id="text">
        <div class="info">
            <h1>Puma x Motorsport</h1>
            <h2>next generation of motorsport</h2>
