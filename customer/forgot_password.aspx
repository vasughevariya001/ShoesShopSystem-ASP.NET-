<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="forgot_password.aspx.cs" Inherits="ShoesShopSystem.WebForm2" %>
        ...
        <div class="container">
            <asp:Panel ID="Panel1" Visible="true">
                ...
                <asp:Panel ID="EmailPanel">
                    ...
                    <asp:Button ID="btnSendOTP" runat="server" CssClass="btn-otp" Text="Send OTP" OnClick="btnSendOTP_Click" />

                </asp:Panel>

                <asp:Panel ID="OTPPanel" Visible="false">
                    ...
                    <asp:Button ID="btnVerify" runat="server" CssClass="btn-verify" Text="Verify" OnClick="btnVerify_Click" />
