<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adidas_shoes_m_sneaker.aspx.cs" Inherits="ShoesShopSystem.WebForm25" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="header">
        <img src="/images/adidas_men's/adidas_background_sneaker.jpg" class="img">
        ...
        <div class="text">
            <p>
                Adidas sneakers for men sit right at the apex of where technology 
                meets fashion in the world of superior footwear. Do right by your 
                feet every day, the 3-Stripes way.
            </p>
        </div>
    </section>
    ...
    <section id="categories-row-1">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="adidas_shoes_m_running.aspx">Running</a>
    ...
    <section id="text">
        <div class="info">
            ...
            <h2>Official kit sponser of indian team</h2>
